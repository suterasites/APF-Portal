...
// ---------------------------------------------------------------------------
// Mock Data - Sessions, Payments, Assessments, Notes, Programs
// ---------------------------------------------------------------------------
...
const mockPayments: PaymentRecord[] = [
  ...
  },
  {
    id: "p2",
    date: "2026-03-15",
    description: "Group Session - March",
    amount: 3000,
    status: "pending",
  },
  {
...
const mockAssessments: AssessmentRecord[] = [
  {
    ...
    coach: "James",
    metrics: [
      { name: "10m Sprint", value: "1.82", unit: "sec" },
      { name: "20m Sprint", value: "3.21", unit: "sec" },
      { name: "40m Sprint", value: "5.65", unit: "sec" },
      { name: "Illinois Agility", value: "16.4", unit: "sec" },
      { name: "Vertical Jump", value: "48", unit: "cm" },
      { name: "Yo-Yo Test", value: "17.2", unit: "level" },
    ],
    notes: "Great improvement on sprint times since last assessment. Agility needs more work.",
  },
  {
    id: "a2",
    date: "2026-01-15",
    coach: "James",
    metrics: [
      { name: "10m Sprint", value: "1.91", unit: "sec" },
      { name: "20m Sprint", value: "3.35", unit: "sec" },
      { name: "40m Sprint", value: "5.88", unit: "sec" },
      { name: "Illinois Agility", value: "17.1", unit: "sec" },
      { name: "Vertical Jump", value: "45", unit: "cm" },
      { name: "Yo-Yo Test", value: "16.8", unit: "level" },
    ],
    notes: "Baseline assessment. Good foundation to build from.",
  },
];
...
const mockNotes: NoteRecord[] = [
  {
    ...
    coach: "James",
    content:
      "Excellent session today. Liam's first touch under pressure has improved significantly. Moving to more complex passing patterns next week.",
  },
  {
    id: "n2",
    date: "2026-03-13",
    coach: "James",
    content:
      "Worked on receiving on the half-turn. Still tends to take heavy touches when fatigued. Will incorporate into conditioning drills.",
  },
  {
    id: "n3",
    date: "2026-03-01",
    coach: "James",
    content:
      "Spoke with Sarah (mum) about increasing to 2 sessions per week. She's keen - will start from next month.",
  },
  {
    id: "n4",
    date: "2026-02-15",
    coach: "James",
    content:
      "Liam mentioned he's been selected for the Richmond SC rep squad. Great progress - a direct result of his commitment to training.",
  },
];
...
const mockPrograms: ProgramRecord[] = [
  {
    id: "pr1",
    name: "Speed Development Phase 2",
  ...
  {
    id: "pr2",
    name: "Technical Foundation Program",
